...
- The **operate / steward** phase (support states, escalation, case lifecycle from the
  *IXO Steward operational playbook*). Out of scope for v1; revisit as a follow‑up.
...
1. **Capsule publishing** — *confirmed published.* The 14 design‑pod skills are live in
