/**
 * Active-page context — a port of the Node runtime's
 * `graph/middlewares/page-context-middleware.ts`. Installed only when the host
 * supplies `hooks.getRoomTitle` (as on Node).
 */
