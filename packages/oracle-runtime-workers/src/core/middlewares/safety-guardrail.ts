/**
 * Safety guardrail — a port of the Node runtime's
 * `graph/middlewares/safety-guardrail-middleware.ts`. Installed only when the
 * host supplies `hooks.safetyModel` (as on Node).
 */
