...
- Every newly authored condition declares \`source: "configured_input"\` or \`source: "runtime_output"\`. Use configured inputs for authored values and runtime output for a previous step's successful result. Untagged stored conditions retain the runner's runtime-output interpretation.
